...
Scale9Sprite::Scale9Sprite()
	: _scale9Sprite(nullptr), _modX(false), _modY(false)
{
...
bool Scale9Sprite::init(Sprite *sprite, const Rect &capInsets)
{
	...
	for (int i = 0; i < 9; i++)
	{
		...
		{
		case 0:
			w = _capInsets.origin.x;
			offset.x = 0.f;
			break;
		case 1:
			w = _capInsets.size.width;
			offset.x = _capInsets.origin.x;
			break;
		case 2:
		...
		{
		case 0:
			h = _capInsets.origin.y;
			offset.y = 0.f;
			break;
		case 1:
			h = _capInsets.size.height;
			offset.y = _capInsets.origin.y;
			break;
		case 2:
...
void Scale9Sprite::setPreferredSize(const Size &preferredSize)
{
	...
	for (int i = 0; i < 9; i++)
	{
		...
		{
		case 0:
			w = capInsets.origin.x;
			offset.x = 0.f;
			break;
		case 1:
			w = capInsets.size.width;
			offset.x = capInsets.origin.x;
			break;
		case 2:
		...
		{
		case 0:
			h = capInsets.origin.y;
			offset.y = 0.f;
			break;
		case 1:
			h = capInsets.size.height;
			offset.y = capInsets.origin.y;
			break;
		case 2:
