...
Value &Value::operator=(const Value &v)
{
	...
	case Type::NONE:
		break;
	case Type::BYTE:
		_field.byteVal = v._field.byteVal;
		break;
	case Type::INTEGER:
		_field.intVal = v._field.intVal;
		break;
	case Type::FLOAT:
		_field.floatVal = v._field.floatVal;
		break;
	case Type::DOUBLE:
		_field.doubleVal = v._field.doubleVal;
		break;
	case Type::BOOLEAN:
		_field.boolVal = v._field.boolVal;
		break;
	case Type::STRING:
	{
...
bool Value::operator==(const Value &v) const
{
	...
	case Type::NONE:
		break;
	case Type::BYTE:
		return _field.byteVal == v._field.byteVal;
		break;
	case Type::INTEGER:
		return _field.intVal == v._field.intVal;
		break;
	case Type::FLOAT:
		return _field.floatVal == v._field.floatVal;
		break;
	case Type::DOUBLE:
		return _field.doubleVal == v._field.doubleVal;
		break;
	case Type::BOOLEAN:
		return _field.boolVal == v._field.boolVal;
		break;
	case Type::STRING:
		return *_field.stringVal == *v._field.stringVal;
		break;
	case Type::VECTOR:
		return *_field.vectorVal == *v._field.vectorVal;
		break;
	case Type::MAP:
		return *_field.mapVal == *v._field.mapVal;
		break;
	case Type::INT_KEY_MAP:
		return *_field.intKeyMapVal == *v._field.intKeyMapVal;
		break;
	default:
		break;
	}
...
unsigned char Value::asByte() const
{
	...
	case Type::STRING:
		return static_cast<unsigned char>(std::atoi(_field.stringVal->c_str()));
		break;
	default:
		break;
	}
...
int Value::asInt() const
{
	...
	case Type::BOOLEAN:
		return _field.boolVal;
	case Type::STRING:
		return static_cast<int>(atoi(_field.stringVal->c_str()));
		break;
	default:
		break;
	}
...
float Value::asFloat() const
{
	...
	case Type::BOOLEAN:
		return _field.boolVal;
	case Type::STRING:
		return static_cast<float>(atof(_field.stringVal->c_str()));
		break;
	default:
		break;
	}
...
double Value::asDouble() const
{
	...
	case Type::BOOLEAN:
		return _field.boolVal;
	case Type::STRING:
		return static_cast<double>(atof(_field.stringVal->c_str()));
		break;
	default:
		break;
	}
...
bool Value::asBool() const
{
	...
	case Type::INTEGER:
		...
		break;
	case Type::FLOAT:
		return _field.floatVal == 0.f ? false : true;
		break;
	case Type::DOUBLE:
	...
	case Type::BOOLEAN:
		return _field.boolVal;
	case Type::STRING:
		return *_field.stringVal == "0" || *_field.stringVal == "false" ? false : true;
		break;
	default:
		break;
	}
...
void Value::clear()
{
	...
	case Type::BOOLEAN:
		...
		break;
	case Type::STRING:
		SDL_SAFE_DELETE(_field.stringVal);
		break;
	case Type::VECTOR:
		SDL_SAFE_DELETE(_field.vectorVal);
		break;
	case Type::MAP:
		SDL_SAFE_DELETE(_field.mapVal);
		break;
	case Type::INT_KEY_MAP:
		SDL_SAFE_DELETE(_field.intKeyMapVal);
		break;
	default:
		break;
	}
