...
MenuItem::MenuItem() : _callback(nullptr), _bEnabled(false), _bSelected(false), _bSwallowed(false)
{
}
...
MenuItemSprite::MenuItemSprite()
	: _normalImage(nullptr), _selectedImage(nullptr), _disabledImage(nullptr)
{
}
...
MenuItemLabel::MenuItemLabel()
	: _label(nullptr), _originalScale(1.f)
{
}
